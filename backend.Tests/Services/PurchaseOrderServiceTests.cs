...
namespace backend.Tests.Services
{
    public class PurchaseOrderServiceTests
    {
        ...
        [Fact]
        public async Task CreatePurchaseOrderAsyncNormalizesOrderAndReturnsSavedOrder()
        {
            // Arrange
        ...
        [Fact]
        public async Task CreatePurchaseOrderAsyncWithBlankSeatClassThrowsArgumentException()
        {
            // Arrange
            var service = CreateService();
            var order = CreateValidOrder();
        ...
        [Fact]
        public async Task CreatePurchaseOrderAsyncWithoutRoutesThrowsArgumentException()
        {
            // Arrange
            var service = CreateService();
            var order = CreateValidOrder();
        ...
        [Fact]
        public async Task CreatePurchaseOrderAsyncWithoutPassengersThrowsArgumentException()
        {
            // Arrange
            var service = CreateService();
            var order = CreateValidOrder();
        ...
        [Fact]
        public async Task CreatePurchaseOrderAsyncWithInvalidRouteIdThrowsArgumentException()
        {
            // Arrange
            var service = CreateService();
            var order = CreateValidOrder();
        ...
        [Fact]
        public async Task CreatePurchaseOrderAsyncWithoutIntendedDateThrowsArgumentException()
        {
            // Arrange
            var service = CreateService();
            var order = CreateValidOrder();
        ...
        [Fact]
        public async Task GetPurchaseOrdersAsyncReturnsRepositoryOrders()
        {
            // Arrange
            var cancellationToken = new CancellationTokenSource().Token;
        ...
        [Fact]
        public async Task GetPurchaseOrderByIdAsyncReturnsRepositoryOrder()
        {
            // Arrange
